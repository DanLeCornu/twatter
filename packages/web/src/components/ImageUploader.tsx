...
export function ImageUploader({ children, path, isDisabled, onSubmit, dropzoneOptions, ...props }: Props) {
  ...
  return (
    <>
      ...
      <Modal {...modalProps} onClose={handleClose} title="Upload new image">
        {image && (
          <Image alt="image preview" objectFit="contain" w="100%" p={6} maxH="400px" src={image.preview} />
        )}
        <ButtonGroup>
